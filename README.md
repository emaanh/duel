...
Before making `duel`, I used websites that do this. But I wanted a system-wide tool where I could save my sessions, and do it from the comfort of my terminal without.

Give `duel` a list. It pits items against each other one at a time, updates Elo scores after each pick, and builds a ranking that reflects your actual preferences. Sessions are saved automatically so you can quit and come back later.
